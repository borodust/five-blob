(asdf:defsystem five-blob
  ...
  :libraries (((:darwin :x86-64) "libfive.dylib" "x86_64/" :nickname :main)
              ((:darwin :x86-64) "libfive.wrapper.dylib" "x86_64/")
              ((:unix (:not :darwin) :x86-64) "libfive.so" "x86_64/" :nickname :main)
              ((:unix (:not :darwin) :x86-64) "libfive.wrapper.so" "x86_64/")
              ((:windows :x86-64) "libfive.dll" "x86_64/" :nickname :main)
